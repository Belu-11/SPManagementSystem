namespace SPManagementSystem.Models
{
    public class TransactionsReposity
    {
        //private static List<Transaction> _transactions = new List<Transaction>();
        //public static IEnumerable<Transaction> GetByDayCashier(string cashierName, DateTime date)
        //{
